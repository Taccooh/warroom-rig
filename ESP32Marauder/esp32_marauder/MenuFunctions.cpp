  ...
  // This is if there are scans/attacks going on
        ...
        (wifi_scan_obj.currentScanMode != WIFI_SCAN_GPS_NMEA))
    {
      ...
      if ((wifi_scan_obj.currentScanMode == WIFI_SCAN_SAE_COMMIT) ||
          ...
          (wifi_scan_obj.currentScanMode == WIFI_SCAN_WAR_DRIVE) ||
          #ifdef MARAUDER_CORE_MODE
            (wifi_scan_obj.currentScanMode == WIFI_SCAN_WAR_DRIVE_CORE) ||
          #endif
  ...
  // Menu navigation and paging
    ...
    // Don't do this for touch screens
      ...
      if (this->isKeyPressed('/')) {
        ...
        #ifdef MARAUDER_CORE_MODE
        // Wardrive-Core: R oeffnet ein kleines Session-Auswahlmenue.
        //   U/D bewegen, C waehlen, R/L abbrechen. Optionen kontextabhaengig:
        //   Lobby      -> [Start Session]
